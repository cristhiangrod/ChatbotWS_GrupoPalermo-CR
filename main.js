...
const STORE_DELETE = "DELETE FROM " + _STORE_ + ".`whatsapp` WHERE (`id_cliente` >= '0')";
data.consultar(STORE_DELETE, []);

// OJO >>>>>>>

// En la ultima version de Whatsapp, Whatsapp ya no permite gaurdar la session y cada que se restaure se debera scanear el QR nuevamente.
